...
Usage (CLI):
    ...
    python3 -m analysis.archive.groove_render \\
...
from analysis.archive.groove_to_midi import groove_to_events, similarity_to_variation
from analysis.archive.simple_synth import render_groove_audio, write_wav
from analysis.midi.midi_extraction import write_note_events_midi, write_multitrack_midi
