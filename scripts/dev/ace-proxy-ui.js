...
const runner = path.join(repoRoot, 'scripts', 'pipelines', 'run-suno-proxy-pipeline.js');
const aceStarter = path.join(repoRoot, 'scripts', 'services', 'start-ace-step-api.sh');
