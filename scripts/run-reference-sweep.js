...
const runner = path.join(repoRoot, 'scripts', 'run-reference-pipeline.js');
...
function printHelp() {
  console.log(`Usage:
  node scripts/run-reference-sweep.js --reference "/absolute/path/to/song.mp3" --output-dir tmp/my-sweep --prompt "direction" --duration full --candidates 4
