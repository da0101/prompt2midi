...
When the UI starts, it checks `http://127.0.0.1:8001/health`. If ACE is not running, it starts `scripts/start-ace-step-api.sh`. If ACE was already running before the UI launched, the UI can still use it and the Stop/Restart buttons can control it.
